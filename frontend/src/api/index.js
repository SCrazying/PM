...
export const addProjectRisk = (id, risk) => request.post(`/projects/${id}/risks`, { risk })
export const setProjectRiskResolved = (rid, resolved) => request.patch(`/risks/${rid}`, { resolved })
...
export const myProgressByMonth = (year, month) => request.get('/progress/mine/month', { params: { year, month } })
